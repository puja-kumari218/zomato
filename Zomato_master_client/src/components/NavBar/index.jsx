  ...
  return (
    <div className="flex w-full items-center justify-between lg:hidden">
      ...
      <div className="flex items-center relative gap-3">
        <button className="bg-zomato-400 text-white py-2 px-3x rounded-full">
          Use App
        </button>
        {reduxState?.fullName ? (
          <>
    ...
    <>
      <div className="hidden lg:inline container px-20 mx-auto">
        <div className="gap-4 w-full items-center justify-around flex">
          ...
          <div
            className="w-3/4 bg-white shadow-md p-3 flex items-center gap-3 border 
...
function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="p-4 flex bg-white shadow-md lg:shadow-none w-full item-center">
